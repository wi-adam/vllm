...
class Qwen3ReasoningParser(BaseThinkingReasoningParser):
    ...
    def extract_reasoning_streaming(
        ...
        content rather than misclassified reasoning.
        """
        ...
        if (
            (has_tool_call_id or just_completed_tool_call_tag)
            and self._tool_call_tag
            and self._tool_call_tag in current_text
        ):
            ...
            if tag_start_idx >= delta_start_idx:
                ...
                tool_reasoning = delta_text[:reasoning_len]
            ...
            return DeltaMessage(
                reasoning=tool_reasoning if tool_reasoning else None,
                content=content if content else None,
            )
